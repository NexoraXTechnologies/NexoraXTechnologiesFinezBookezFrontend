...
// 			title: "Status",
// 			render: (row: any) => (
// 				<span className="inline-flex rounded-md border border-primary/20 bg-primary/10 px-2 py-1 text-xs font-medium capitalize text-primary">
// 					{String(row?.tripStatus || row?.status || "-").replace(/_/g, " ")}
// 				</span>
// 			),
// 		}
// 	];
