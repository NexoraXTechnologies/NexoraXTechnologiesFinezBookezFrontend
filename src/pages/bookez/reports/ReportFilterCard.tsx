...
//         flex h-11 items-center justify-center gap-2 rounded-md px-4 text-sm font-bold text-white transition
//         ${downloadDisabled
...
//                     <div className="flex h-8 items-center gap-3 rounded-sm border border-slate-200 bg-slate-50 px-4">
