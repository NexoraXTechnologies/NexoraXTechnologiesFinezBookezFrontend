...
import { addCreditNoteRegister } from "../../../redux/slices/professionalSlice/bookEzRegister/creditNoteRegisterSlice";

import { Eye } from "lucide-react";
import { getCreditNoteByVoucherNumber } from "../../../redux/slices/professionalSlice/openingBalancesStocks/creditNoteSlice";
...
const normalizeCreditNoteForView = (
    record: any
) => {
    const rawItems =
        Array.isArray(
...
const CreditNoteRegister = () => {
    ...
    const handleViewVoucher =
        async (
            ...
            if (
                ...
                console.log(
                    "Sales credit note voucher number missing:",
                    row
                );
            ...
            error
                ...
                console.log(
                    "Sales credit note register view failed",
                    error
                );
            ...
            try {
                ...
                if (
                    ...
                    downloadBlobFile(
                        ...
                        type ===
                            "pdf"
                            ? "sales-credit-note-register.pdf"
                            : "sales-credit-note-register.xlsx"
                    );
                }
            } catch (
            error:
                ...
                console.log(
                    `Sales credit note register ${type.toUpperCase()} download failed`,
                    error
                );
    ...
    return (
        <div className="flex h-full w-full flex-col gap-4 bg-background p-4 text-foreground">
            <RegisterFilterCard
                title="Sales Credit Note Register Filters"
                fields={[
                    {
                        key: "fromDate",
                        type: "date",
            ...
            <DataTable
                ...
                emptyMessage="No sales credit note register data found"
                showFieldSelector={
                    false
                }
                actions={(
