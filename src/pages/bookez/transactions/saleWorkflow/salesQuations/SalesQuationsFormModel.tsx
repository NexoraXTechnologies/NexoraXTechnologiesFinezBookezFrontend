...
/* ===================================================
    SALES QUOTATION FORM MODAL
=================================================== */

type SalesQuotationsFormModalProps = {
  showModal: boolean;
...
const SalesQuotationsFormModal = ({
  showModal,
  setShowModal,
          ...
          <div className="col-span-2 w-full space-y-5">
            ...
            <div className="rounded-md border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <ColumnWiseTable
                ...
                onEdit={(item, index) => handleEditProduct(item, index)}
...
export default SalesQuotationsFormModal;