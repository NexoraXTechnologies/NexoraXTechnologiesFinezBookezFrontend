...
const CreateEditEngineeringConfig = () => {
    ...
    const renderField = (field: any) => {
        ...
        ${field.disabled ? "cursor-not-allowed bg-slate-100 text-slate-500" : "focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"}
    `;
        ...
        <div className=" bg-slate-50">
            ...
            <div className="grid h-[calc(100vh-73px)] grid-cols-1 gap-4 overflow-hidden p-4 xl:grid-cols-[360px_1fr] 2xl:grid-cols-[420px_1fr]">
                ...
                <div className="flex min-h-0 flex-col overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
                        ...
                        {showAutoCalculatedFields && (
                            <div className="rounded-xl border border-indigo-100 bg-gradient-to-br from-indigo-50 via-white to-blue-50 p-4 shadow-sm">
                                <div className="mb-4 flex items-start justify-between gap-3">
                                    ...
                                    <span className="rounded-full bg-indigo-100 px-3 py-1 text-[11px] font-black text-indigo-700">
                                        Auto
                                    </span>
                                </div>
                    ...
                    <div className="flex border-t border-slate-200 bg-white p-4 gap-4">
                        ...
                        <button
                            ...
                            className="flex h-10 w-full items-center justify-center rounded-md border border-slate-200 bg-white px-4 text-sm font-bold text-slate-700 transition hover:bg-slate-50"
                        >
                            Reset
                        </button>
                        ...
                        <button
                            ...
                            className="flex h-10 w-full items-center justify-center rounded-md bg-indigo-600 px-4 text-sm font-bold text-white transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-60"
                        >
                    ...
                    <div className="flex items-center justify-between gap-3 border-b border-slate-200 px-4 py-3">
                        ...
                        {/* <div className="flex items-center gap-2">
                            <button
                                ...
                                onClick={handleSubmit}
                                disabled={addLoader}
                                className="rounded-md border border-slate-200 px-3 py-2 text-xs font-bold text-slate-700 hover:bg-slate-50 disabled:opacity-60"
                            >
                                Recalculate
                            </button>
                            ...
                            <button
                                type="button"
                                className="rounded-md bg-indigo-600 px-3 py-2 text-xs font-bold text-white hover:bg-indigo-700"
                            >
                                Export
                            </button>
                        </div> */}
