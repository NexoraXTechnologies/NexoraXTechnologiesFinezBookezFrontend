...
//     const customModuleTabs = useMemo(
//         () =>
//             (transactionModules || []).map((item: TransactionModuleItem) => ({
...
//                                 </span>
//                                 <span className="mt-1 block text-xs font-medium leading-5 text-muted-foreground">
//                                     {item.description || `Configure ${item.moduleName} fields`}
//                                 </span>
//                             </span>
//                         </button>
//                     ))}
...
//                                     ? activeTab === "customTransactionSchema" &&
//                                     selectedCustomModule?.moduleCode === (tab as any).module?.moduleCode
//                                     : activeTab === tab.key ||
//                                     (tab.key === "customTransactions" &&
//                                         activeTab === "customTransactionSchema" &&
...
//                                         onClick={() => {
//                                             if (isCustomTab) {
//                                                 openCustomModuleSchema((tab as any).module);
//                                                 return;
//                                             }
