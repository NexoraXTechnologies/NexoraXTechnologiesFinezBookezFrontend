        ...
        pagination.totalDocs > 0 && (
          ...
          >
            ...
            <div>
              ...
              of <strong>{pagination.totalDocs}</strong> | Page{" "}
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                disabled={!pagination.hasPrevPage}
                onClick={() =>
                  setLocalOffset((prev) => Math.max(0, prev - localLimit))
                }
                className="px-3 py-1 border rounded disabled:opacity-40"
              >
                Prev
              ...
              <button
                ...
                onClick={() => setLocalOffset((prev) => prev + localLimit)}
                className="px-3 py-1 border rounded disabled:opacity-40"
              >
                Next
              </button>
              ...
              <button
                disabled={!pagination.hasNextPage}
                onClick={() =>
                  setLocalOffset((pagination.totalPages - 1) * localLimit)
                }
                className="px-3 py-1 border rounded disabled:opacity-40"
              >
                Last
