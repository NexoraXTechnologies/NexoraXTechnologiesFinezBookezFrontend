...
const DataCreateButton = (({ callBackFn, text = "Add Account", icon, disabled = false }: { callBackFn: () => void, text?: string, icon?: any, disabled?: boolean }) => {
    return (
...
const PrimaryButton = (({ callBackFn, text, icon = null , disabled = false, className = "" }: any) => (
